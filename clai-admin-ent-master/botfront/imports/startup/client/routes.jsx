...
import ServicesListContainer from '../../ui/components/admin/Services';
import ModelsListContainer from '../../ui/components/admin/Models';
import ProjectContainer from '../../ui/components/admin/Project';
// import ServiceContainer from '../../ui/components/admin/Service';
                        ...
                        <Provider store={store}>
                            <Router history={browserHistory}>
                                ...
                                <Route exact path='/admin' component={AdminLayout} onEnter={authenticateAdminPage()}>
                                    ...
                                    <Route path='/admin/services' component={ServicesListContainer} name='Services' onEnter={authenticate('services:r', { scope: 'anyScope' })} />
                                    <Route path='/admin/models' component={ModelsListContainer} name='Models' onEnter={authenticate('models:r', { scope: 'anyScope' })} />
                                    
                                    {/* <Route path='/admin/service/:service_id' component={ServiceContainer} name='Service' onEnter={authenticate('services:w', { scope: 'GLOBAL' })} />
                                    <Route path='/admin/service/add' component={ServiceContainer} name='Service' onEnter={authenticate('services:w', { scope: 'GLOBAL' })} /> */}
