        ...
        return (
            <>
                ...
                >
                    ...
                    <AutoField label='Title' name='title' data-cy='widget-title' />
                    <AutoField label='Subtitle' name='subtitle' />
                    <InfoField
                        required={false}
                    ...
                    <ColorField label='Title color' name='widgetTitleColor' />
                    <ColorField label='Subtitle color' name='widgetSubtitleColor' />
                    <ColorField label='Main color' name='mainColor' />
                    <ColorField label='Button color' name='buttonColor' />
                    <ColorField
                    ...
                    <Accordion>
                        ...
                        <Accordion.Content active={advancedVisible}>
                            ...
                            <InfoField
                                ...
                                required={false}
                                info='If set, close message will not appear when the widget is closed.'
                                Component={ToggleField}
                            ...
                            />
                            <Divider />
                            <LongTextField label='Buttons style' name='btncss' data-cy='Buttons Css' />
                            <InfoField
                        name='UserconvFont'
                        label='User Conversation Font Size'
                        data-cy='user-conversation-font'
                    />
                    <InfoField
                        name='AssistantconvFont'
                        label='Assistant Conversation Font Size'
