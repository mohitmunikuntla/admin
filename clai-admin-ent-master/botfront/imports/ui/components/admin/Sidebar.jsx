        ...
        return (
            <Menu vertical inverted pointing style={style}>
                <Menu.Item>
                    ...
                    {can('services:r', { anyScope: true }) && (
                        <Link to='/admin/services'>
                            <Menu.Item name='Services' data-cy='services-link'> Services</Menu.Item>
                        </Link>
                    )}
                    {can('models:r', { anyScope: true }) && (
                        <Link to='/admin/models'>
                            <Menu.Item name='Models' data-cy='models-link'> Models </Menu.Item>
                        </Link>
                    )}
