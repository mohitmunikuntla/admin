...
function ResponseMetadataForm({
    ...
    const postProcess = (model) => {
        ...
        if (newModel.pageEventCallbacks && newModel.pageEventCallbacks.enabled) {
            ...
            if (newModel.pageEventCallbacks.pageEvents[0].errorIntent){
                newModel.pageEventCallbacks.pageEvents[0].errorIntent = addSlashIfNeeded(newModel.pageEventCallbacks.pageEvents[0].errorIntent);
            }
        }
