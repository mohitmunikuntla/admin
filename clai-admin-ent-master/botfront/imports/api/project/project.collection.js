...
if (Meteor.isServer) {
    ...
    Meteor.publish('projects.dropdown', function () {
        if (can('projects:r', null, this.userId)) {
            return Projects.find({disabled: { $ne: true}}, { fields: { name: 1 } });
        }
    ...
    Meteor.publish('projects.services', function () {
        if (can('projects:r', null, this.userId)) {
            return Projects.find({}, { fields: { name: 1, defaultDevelopmentService: 1, defaultProductionService: 1, trainingService: 1 } });
        }
        const projects = getUserScopes(this.userId, [
            'responses:r',
            'nlu-data:r',
        ...
        return Projects.find({ _id: { $in: projects } }, { fields: { name: 1, defaultDevelopmentService: 1, defaultProductionService: 1, trainingService: 1 } });
    });
