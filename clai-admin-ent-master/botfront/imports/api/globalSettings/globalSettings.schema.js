...
export const privateSettingsSchema = new SimpleSchema({
    ...
    CLAIENVSPATH: { type: String, optional: true},
    CLAIMODELSPATH: { type: String, optional: true },
    defaultCredentials: { type: String, custom: validateYaml, optional: true, defaultValue: '' },
    defaultClaiService: { type: String, optional: true, defaultValue: '' },
