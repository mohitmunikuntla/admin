...
export const validateClaiService = (files, params) => validateSimpleYamlFiles(files, params, 'claiservice');

export const validateModels = (files, params) => validateSimpleYamlFiles(files, params, 'models');
...
export const validateBfConfig = (files, params) => {
    ...
    if (onlyValidConfigFiles.length > 0 && onlyValidConfigFiles[0].bfconfig?.instance) {
        ...
        let claiservice;
        let instance = {};
        const project = Projects.findOne({_id: params.projectId});
