...
const formatDateBuckets = (data, bucketSize, projectTimezoneOffset) => data
    .map((c) => {
        ...
        // const localTimezone = new Date(parseInt(c.bucket, 10) * 1000 - 43200000).getTimezoneOffset() * 60 * 1000 + projectTimezoneOffset * 60 * 60 * 1000;  //to use projectTimezoneOffset
        const localTimezone = new Date(parseInt(c.bucket, 10) * 1000 - 43200000).getTimezoneOffset() * 60 * 1000 + projectTimezoneOffset;
        if (bucketSize === 'day') {
            return {
                ...c,
